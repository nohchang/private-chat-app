...
const appendMessage = ({ message, time, backgroud, position }) => {
  let div = document.createElement('div');
  div.classList.add('message', 'bg-opacity-25', 'm-2', 'px-2', 'py-1', backgroud, position);
...
msgForm.addEventListener('submit', (e) => {
  ...
  appendMessage({ ...payload, backgroud: 'bg-success', position: 'right' });
